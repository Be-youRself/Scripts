...
class Ui_Translation_box(object):
    def setupUi(self, Translation_box):
        ...
        Translation_box.resize(734, 45)
        Translation_box.setMinimumSize(QtCore.QSize(734, 45))
        Translation_box.setMaximumSize(QtCore.QSize(734, 45))
        self.centralwidget = QtWidgets.QWidget(Translation_box)
        self.centralwidget.setObjectName("centralwidget")
        self.Show_box = QtWidgets.QLabel(self.centralwidget)
        self.Show_box.setGeometry(QtCore.QRect(0, 0, 734, 45))
